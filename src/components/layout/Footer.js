...
const Footer = props => {
    ...
    return (
        <footer className="py-12 text-center bg-gray-100 text-gray-900 ">
            <img className="w-16 mb-4 mx-auto opacity-25" src={Logo} alt="Blue Diamond Media Logo" />
            ...
            <h5 className="text-lg mt-2 font-thin opacity-25 ">&copy; Blue Diamond Media {new Date().getFullYear()}</h5>
